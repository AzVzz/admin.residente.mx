...
/**
 * Vista "Entrevista" del dashboard: lista SOLO las entrevistas del formulario
 * público "Centro de Entrevistas" (tipo_nota2="centro-entrevistas").
 */
const MARCA_ORIGEN = "centro-entrevistas";
const POR_PAGINA = 15;

const CentroEntrevistasDashboard = () => {
  const { token } = useAuth();
  ...
  const eliminarNota = async (id) => {
    if (
      !window.confirm(
        "¿Eliminar esta entrevista? Esta acción no se puede deshacer.",
      )
    )
      return;
    setEliminando(id);
    ...
    <div className="w-full">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Entrevistas recibidas por el formulario público. Revisa las respuestas
          y categoriza la nota al publicarla.
        </p>
      </div>
      ...
      {cargando ? (
        ...
        <div className="text-center py-12">
          <p className="text-red-600 mb-4">
            Ocurrió un error al cargar las entrevistas del formulario.
          </p>
          <button
            onClick={cargar}
        ...
        <div className="bg-white rounded-xl shadow p-8 text-center">
          <h3 className="text-xl font-medium text-gray-900 mb-2">
            Aún no hay entrevistas del formulario
          </h3>
        ...
        <>
          ...
          <div className="flex flex-col items-center mt-8 space-y-3">
            <div className="text-sm text-gray-600">
              {total} entrevista{total === 1 ? "" : "s"} en total
            </div>
            {totalPaginas > 1 && (
...
export default CentroEntrevistasDashboard;
