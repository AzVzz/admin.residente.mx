...
const VideosDashboard = () => {
  ...
  const toggleEstado = async (id) => {
    try {
      ...
      const resultado = await toggleVideoEstadoInteligente(
        id,
        token,
        estadoActual
      );
      ...
      if (resultado.success) {
        ...
        setTimeout(() => {
          if (!nuevoEstado) {
            ...
            const videosInactivosSection =
              document.getElementById("videos-inactivos");
            ...
            const videosActivosSection =
              document.getElementById("videos-activos");
        ...
        setMensajeExito(
          `Video ${nuevoEstado ? "activado" : "desactivado"} exitosamente`
        );
        limpiarMensajes();
      } else {
            ...
            <div id="videos-activos" className="bg-white rounded-lg shadow">
              ...
              {videos.filter((v) => v.activo).length === 0 ? (
                <div className="px-6 py-8 text-center">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900">
                    No hay videos activos
                  </h3>
                  <p className="mt-1 text-sm text-gray-500">
                    Todos los videos están inactivos.
                  </p>
                </div>
              ) : (
                        ...
                        .map((video) => (
                          ...
                          >
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex-shrink-0 h-16 w-16">
                                <img
                                  ...
                                  onError={(e) => {
                                    e.target.src =
                                      "/fotos/fotos-estaticas/fotodeprueba.png";
                                  }}
                                />
                              </div>
                            </td>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                              ...
                              <button
                                onClick={() =>
                                  navigate(`/videosFormulario/${video.id}`)
                                }
            ...
            <div id="videos-inactivos" className="bg-white rounded-lg shadow">
              ...
              {videos.filter((v) => !v.activo).length === 0 ? (
                <div className="px-6 py-8 text-center">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900">
                    No hay videos inactivos
                  </h3>
                  <p className="mt-1 text-sm text-gray-500">
                    Todos los videos están activos.
                  </p>
                </div>
              ) : (
                <div className="overflow-x-auto">
            ...
            <div className="mt-3 text-center">
              ...
              <div className="mt-2 px-7 py-3">
                <p className="text-sm text-gray-500">
                  ¿Estás seguro de que quieres eliminar este video? Esta acción
