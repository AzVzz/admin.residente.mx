        ...
        <div className="grid grid-cols-5 gap-2 justify-center">
            ...
            {!ocultarTipoNota && (
                <div className="p-1 border border-gray-200 rounded-md bg-white flex flex-col h-full">
                    <p className="mb-2 text-lg font-bold bg-gray-100 p-1 text-center rounded text-gray-700">Tipo de Nota</p>
                            ...
                            render={({ field }) => (
                                <>
                                    {tipoDeNota.map((opcion, idx) => (
                                        <label key={idx} className="block mb-1 cursor-pointer hover:bg-gray-50 p-1 rounded text-sm">
                                            <input
                                                type="radio"
                                                value={opcion.nombre}
            ...
            {secciones.map((seccion) => {
                ...
                return (
                    <div key={seccion.seccion} className="p-1 border border-gray-200 rounded-md bg-white flex flex-col h-full">
                        <h2 className="mb-2 text-lg font-bold bg-gray-100 p-1 text-center rounded text-gray-700">{seccion.seccion}</h2>
                        <div className="flex-1 overflow-y-auto max-h-96 px-1">
