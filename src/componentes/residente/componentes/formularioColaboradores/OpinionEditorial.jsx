...
<<<<<<< HEAD
    <Box 
      sx={{ 
        backgroundColor: '#ffff00', // Fondo amarillo brillante como en la imagen
        minHeight: '100vh',
        padding: { xs: 2, md: 4 },
    ...
    >
      ...
      <Box sx={{ textAlign: 'left', mb: 6, maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{
          fontSize: '2.5rem',
          fontWeight: 'bold',
          color: '#000000',
      ...
      {/* Formulario - directamente sobre fondo amarillo */}
      <Box
        component="form"
