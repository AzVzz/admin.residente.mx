  ...
  const [tiposNotas, setTiposNotas] = useState([
    {
      nombre: "Restaurantes",
      tipoLogo:
        "fotos/fotos-estaticas/residente-logos/grises/residente-restaurant-media.webp",
      marqueeTexto:
    ...
    },
    {
      nombre: "Food & Drink",
      tipoLogo:
        "fotos/fotos-estaticas/residente-logos/grises/food-&-drink-media.webp",
      marqueeTexto:
          ...
          <div key={tipo} className="flex flex-col pt-9">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-4 mb-9">
              ...
              <div>
                <div className="relative flex justify-center items-center mb-4">
                  ...
                  <div className="relative z-10 px-4 bg-[#fff300]"></div>
                </div>
            ...
            {tipo === "Restaurantes" && (
              <>
                <div className="relative flex justify-center items-center mb-4">
                  ...
                  <div className="relative z-10 px-4 bg-[#fff300]">
                    <div className="flex flex-row justify-center items-center gap-2">
                      <img
                        src={`${imgApi}fotos/fotos-estaticas/listado-iconos-100estrellas/favoritsdelpublico.avif`}
                        className="w-7.5 h-full object-contain rounded-full"
                      />
                ...
                <EnPortada onCardClick={(nota) => handleCardClick(nota.id)} />
              </>
            )}
            {tipo === "Antojos" && (
              <>
                ...
                <div className="relative flex justify-center items-center mb-4">
                  ...
                  <div className="relative z-10 px-4 bg-[#fff300]">
                    <div className="flex flex-row justify-center items-center gap-3">
                      <img
                        src={`${imgApi}fotos/fotos-estaticas/residente-logos/grises/platillos-iconicos.webp`}
