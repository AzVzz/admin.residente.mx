        ...
        const fetchNotas = async () => {
            try {
                ...
                const response = await fetch(
                    `${urlApi}api/notas/destacadasnew/restaurantes?soloMes=0&orden=fecha&t=${timestamp}`
                );
                            ...
                            >
                                ...
                                <div className="w-full flex justify-start mb-1.5">
                                    {stickersConResidente.map((clave, idxIcono) => {
                                        ...
                                        return icono ? (
                                            <img
                                                key={`${nota.id}-${clave}-${idxIcono}`}  // ← Cambiar aquí
                                                src={icono.icono}
                                                alt={icono.nombre}
...
export default InstaRecomendaciones;