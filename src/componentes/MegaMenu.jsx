          ...
          <div className="flex items-center justify-between px-0 py-3 contenedor-header-2">
            ...
            <div className="flex items-center space-x-4 contenedor-header-4">
              ...
              >
                <img
                  src={
                    `${imgApi}fotos/fotos-estaticas/residente-logos/blancos/B2BSoluciones-logo-blanco.webp` ||
                    "/placeholder.svg"
                  }
                  alt="B2B Soluciones"
              ...
              <div className="flex flex-row gap-3 justify-between">
                <a
                  href="https://www.instagram.com/residentemty/"
                  className="text-white hover:text-[#FFF200] transition-colors"
                >
                  <FaInstagram size={20} />
                </a>
                <a
                  href="https://www.facebook.com/residentemx"
                  className="text-white hover:text-[#FFF200] transition-colors"
                >
                  <FaFacebook size={20} />
                </a>
                <a
                  href="https://www.youtube.com/@revistaresidente5460"
                  className="text-white hover:text-[#FFF200] transition-colors"
                >
                  <FaYoutube size={20} />
                </a>
                <a
                  href="tel:+528114186987"
                  className="text-white hover:text-[#FFF200] transition-colors"
                >
                  <FaWhatsapp size={20} />
                </a>
                <a
                  href="mailto:contacto@residente.mx?subject=%C2%A1Quiero%20m%C3%A1s%20informaci%C3%B3n%20de%20Residente!"
                  className="text-white hover:text-[#FFF200] transition-colors"
                >
                  <MdEmail size={20} />
                </a>
            ...
            <div className="max-w-[1080px] mx-auto w-full pt-2">
              ...
              <div className="px-0 py-3 border-b border-[#3B3B3C]">
                <p className="text-[clamp(.7rem,1.4vw,1rem)] text-white uppercase tracking-wide">
                  TODOS LOS RESTAURANTES, ALIMENTOS, BEBIDAS, POSTRES Y
                  EXPERIENCIAS GASTRONÓMICAS DE NUEVO LEÓN
                </p>
              </div>
              ...
              <div className="flex flex-row gap-8 px-0 pb-8 justify-between contenedor-header-menu">
                ...
                {menuHeader.map((section, idx) => (
                  <div
                    key={idx}
                    className="space-y-4 secciones-container-computadora"
                  >
                    {section.submenu ? (
                      <>
                        <h3 className="text-[#FFF200] font-bold text-lg mb-1">
                          {section.seccion}
                        </h3>
                        <ul>
