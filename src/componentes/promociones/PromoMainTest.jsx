...
import { cuponCrearTest } from '../../componentes/api/cuponesGetTest';
...
const PromoMainTest = () => {
    ...
    const handleGuardar = async () => {
        ...
        try {
            ...
            const response = await cuponCrearTest(apiData, token);
            console.log("✅ Promoción creada (TEST):", response);
