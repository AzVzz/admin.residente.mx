            ...
            <div className="max-w-[1080px] mx-auto px-4">
                ...
                <div className="flex sm:flex-row justify-between items-center mb-4 sm:mb-8 gap-2">
                    <div className="flex items-center gap-3">
                        <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/fooddrinkmedia-logo-blanco.webp" alt="FoodDrinkMedia" className="w-full sm:h-10 object-contain" />
                    </div>
                ...
                <div className="grid sm:grid-cols-7 grid-cols-4 gap-9 mb-8">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-5">
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/magazine-logo-blanco.webp" alt="Magazine"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/guia-logo-blanco.webp" alt="Guia"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/discpromo-logo-blanco.webp" alt="DiscPromo"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/books-logo-blanco.webp" alt="Books"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/residente-video-logo-blanco.webp" alt="Video"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-5">
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/newsletter-logo-blanco.webp" alt="Newsletter"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/researchdata-logo-blanco.webp" alt="ResearchData"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/residente-restauranat-networking.webp" alt="Networking"
                                className="sm:w-25 w-13 h-auto object-contain"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-5">
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/platillos-logo-blanco.webp" alt="Platillos" className="sm:w-25 w-13 h-auto object-contain" />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/logo-estrellas-de-nl.webp" alt="Estrellas de NL" className="sm:w-25 w-13 h-auto object-contain" />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/rostros-logo-blanco.webp" alt="Rostros" className="sm:w-25 w-13 h-auto object-contain" />
                        </div>
                    </div>
                    {/* Columna 4 */}
                    <div>
                        ...
                        <div className="flex flex-col gap-5">
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/afirme-logo.webp" alt="Afirme" className="sm:w-25 w-13 h-auto object-contain" />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/canirac-logo.webp" alt="Canirac" className="sm:w-25 w-13 h-auto object-contain" />
                            <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/usda-blanco.webp" alt="USDA" className="sm:w-25 w-13 h-auto object-contain" />
                        </div>
                    </div>
                    {/* Columna 5 */}
                    <div></div>
                ...
                <div className="flex justify-center items-center gap-5 mb-4">
                    <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/relevant-logo-blanco.webp" alt="RELEVANT" className="w-25 h-5" />
                    <img src="https://residente.mx/fotos/fotos-estaticas/residente-logos/blancos/endeavor-logo-blanco.webp" alt="Endeavor" className="w-25 h-5 -mt-2" />
                </div>
